...
public class BossWanda extends BossFactory {
    ...
    public ComponentBag wanda(float x, float y) {
        ...
        bag.add(new com.bryjamin.wickedwizard.ecs.components.ai.FiringAIComponent());
    ...
    private class AOEShieldBlastTask implements Task {
        ...
        public void performAction(World world, Entity e) {
            ...
            e.edit().add(new com.bryjamin.wickedwizard.ecs.components.WeaponComponent(new ShieldBlast(), shieldBlastWarningTime));
    ...
    private class Phase3 implements Task {
        ...
        public void performAction(World world, Entity e) {
            ...
            e.edit().add(new com.bryjamin.wickedwizard.ecs.components.WeaponComponent(new FanWeapon(angles), 1f));
