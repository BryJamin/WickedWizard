...
public class ItemBubble implements Item {
    ...
    public boolean applyEffect(World world, Entity player) {
        player.getComponent(com.bryjamin.wickedwizard.ecs.components.StatComponent.class).shotSpeed += com.bryjamin.wickedwizard.factories.items.passives.PresetStatIncrease.major;
