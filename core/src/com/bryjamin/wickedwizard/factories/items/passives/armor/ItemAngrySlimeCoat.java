...
public class ItemAngrySlimeCoat implements Item {
    ...
    public boolean applyEffect(World world, Entity player) {
        ...
        player.getComponent(com.bryjamin.wickedwizard.ecs.components.StatComponent.class).damage += com.bryjamin.wickedwizard.factories.items.passives.PresetStatIncrease.Speed.minor;
        return true;
    }
