...
public class LaserBeam {
    ...
    public LaserBeam(LaserBeamBuilder lbb){
        ...
        this.atlas = assetManager.get(com.bryjamin.wickedwizard.assets.FileLocationStrings.spriteAtlas);
    ...
    public Entity createBeam(World world, float x, float y){
        ...
        TextureRegionComponent trc = new TextureRegionComponent(atlas.findRegion(com.bryjamin.wickedwizard.assets.TextureStrings.BLOCK), chargingLaserWidth, chargingLaserHeight, TextureRegionComponent.ENEMY_LAYER_MIDDLE,
        ...
        beam.edit().add(new ActionAfterTimeComponent(new Action() {
            ...
            public void performAction(World world, Entity e) {
               ...
               // e.edit().remove(FollowPositionComponent.class);
                ...
                activeBeam.edit().add(new com.bryjamin.wickedwizard.ecs.components.ai.OnDeathActionComponent(new Action() {
                    @Override
                    public void performAction(World world, Entity e) {

                        e.edit().remove(com.bryjamin.wickedwizard.ecs.components.ai.OnDeathActionComponent.class);
