...
public class ChallengesWorldContainer extends com.bryjamin.wickedwizard.utils.AbstractGestureDectector implements com.bryjamin.wickedwizard.screens.world.WorldContainer {
    ...
    public void createWorld() {
        ...
        count = createChallengeButtons(world, count, com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.Rank1Challenges.rank1ChallengesArray, com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.LEVEL_1_COMPLETE);
        count = createChallengeButtons(world, count, com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.Rank2Challenges.rank2ChallengesArray,
                com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.LEVEL_2_COMPLETE);
        count = createChallengeButtons(world, count, com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.Rank3Challenges.rank3ChallengesArray,
                com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.LEVEL_3_COMPLETE);
        count = createChallengeButtons(world, count, com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.Rank4Challenges.rank4ChallengesArray,
                com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.LEVEL_4_COMPLETE);
        count = createChallengeButtons(world, count, com.bryjamin.wickedwizard.factories.arenas.challenges.ChallengesResource.Rank5Challenges.rank5ChallengesArray,
                        ...
                        .action(new Action() {
                            ...
                            public void performAction(World world, Entity e) {
                                ...
                                try {
                                    ...
                                    game.setScreen(new com.bryjamin.wickedwizard.screens.PlayScreen(game, gameCreator));
