...
public class MapGUI {
    ...
    private OrderedSet<com.byrjamin.wickedwizard.archive.maps.rooms.Room> rooms;
    ...
    public MapGUI(float x, float y, OrderedSet<com.byrjamin.wickedwizard.archive.maps.rooms.Room> rooms, com.byrjamin.wickedwizard.archive.maps.rooms.Room currentRoom) {
        this.mapx = x;
        this.mapy = y;
        this.rooms = rooms;
    ...
    public void update(float dt, OrthographicCamera gamecam, OrderedSet<com.byrjamin.wickedwizard.archive.maps.rooms.Room> visitedRooms, com.byrjamin.wickedwizard.archive.maps.rooms.Room currentRoom){
    ...
    public void drawMapLines(SpriteBatch batch){
        ...
        for(com.byrjamin.wickedwizard.archive.maps.rooms.Room r : rooms){
            ...
            for(com.byrjamin.wickedwizard.archive.maps.rooms.components.RoomExit re : r.getRoomExits()) {
                ...
                //Left Line
                if(re.getDirection() == com.byrjamin.wickedwizard.archive.maps.rooms.components.RoomExit.EXIT_DIRECTION.LEFT) {
                    mapRenderer.line(x, y + MINI_SIZE, x, y + SIZE - MINI_SIZE);
                }

                //Right Line
                if(re.getDirection() == com.byrjamin.wickedwizard.archive.maps.rooms.components.RoomExit.EXIT_DIRECTION.RIGHT) {
                    mapRenderer.line(x + SIZE, y + MINI_SIZE, x + SIZE, y + SIZE - MINI_SIZE);
                }

                //Top Line
                if(re.getDirection() == com.byrjamin.wickedwizard.archive.maps.rooms.components.RoomExit.EXIT_DIRECTION.UP) {
                    mapRenderer.line(x + MINI_SIZE, y + SIZE, x + SIZE - MINI_SIZE, y + SIZE);
                }

                //Bottom Line
                if(re.getDirection() == com.byrjamin.wickedwizard.archive.maps.rooms.components.RoomExit.EXIT_DIRECTION.DOWN) {
