package com.byrjamin.wickedwizard.archive.gameobject.bosses;
...
import com.byrjamin.wickedwizard.utils.timer.Reloader;
 ...
 */
public class BiggaBlobba extends com.byrjamin.wickedwizard.archive.gameobject.enemies.GroundedEnemy {
    ...
    public void phase1Update(float dt, Room a){
        ...
        if(littleSlimer.isReady()){
            a.getEnemies().add(com.byrjamin.wickedwizard.archive.gameobject.enemies.EnemyPresets.smallBlob(lowerBody.x, lowerBody.y));
            slimeCount --;
        }
