 ...
 */
public class LaserOrbital implements Task {
    ...
    private float numberOfOrbitals;
    private float chargeTime;

    private TextureAtlas atlas;

    public LaserOrbital(AssetManager assetManager, float size, float speedInDegrees, float numberOfOrbitals, float chargeTime, int[] angles){
        this.size = size;
    ...
    public void setNumberOfOrbitals(float numberOfOrbitals) {
        this.numberOfOrbitals = numberOfOrbitals;
    }
